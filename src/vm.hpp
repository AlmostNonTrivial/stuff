...
namespace Pattern{
    inline VMInstruction create(int32_t str_reg, int32_t pattern_reg,
                                int32_t result_reg, PatternType type) {
    ...
    inline int32_t str_reg(const VMInstruction &inst) { return inst.p1; }
    inline int32_t pattern_reg(const VMInstruction &inst) { return inst.p2; }
    inline int32_t result_reg(const VMInstruction &inst) { return inst.p3; }
    inline PatternType pattern_type(const VMInstruction &inst) { return (PatternType)inst.p5; }

    inline void print(const VMInstruction &inst) {
        printf("Like str_reg=%d pattern_reg=%d result_reg=%d case_insensitive=%d",
