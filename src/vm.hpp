...
// ============================================================================
// Opcode Descriptors - Each opcode knows how to create, access, and print itself
// ============================================================================
...
struct Trace {
    ...
    static const char* message(const VMInstruction& inst) { return (const char*)inst.p4; }
...
// Cursor Operations
struct OpenRead {
    static VMInstruction create(int32_t cursor_id, const char* table_name, int32_t index_col = 0) {
    ...
    static const char* table_name(const VMInstruction& inst) { return (const char*)inst.p4; }
    static void print(const VMInstruction& inst) {
...
struct Rewind {
    ...
    static void print(const VMInstruction& inst) {
        printf("cursor=%d", cursor_id(inst));
        if (jump_if_empty(inst) >= 0) printf(" empty->%d", jump_if_empty(inst));
    }
};
...
struct Next {
    ...
    static void print(const VMInstruction& inst) {
        printf("cursor=%d", cursor_id(inst));
        if (jump_if_done(inst) >= 0) printf(" done->%d", jump_if_done(inst));
    }
};
...
// Seek Operations
struct SeekGE {
    static VMInstruction create(int32_t cursor_id, int32_t key_reg, int32_t jump_if_not_found = -1) {
        return {OP_SeekGE, cursor_id, key_reg, jump_if_not_found, nullptr, 0};
    }
    static VMInstruction create_label(int32_t cursor_id, int32_t key_reg, const char* label) {
        return {OP_SeekGE, cursor_id, key_reg, -1, (void*)label, 0};
    }
    static int32_t cursor_id(const VMInstruction& inst) { return inst.p1; }
    static int32_t key_reg(const VMInstruction& inst) { return inst.p2; }
    static int32_t jump_if_not_found(const VMInstruction& inst) { return inst.p3; }
    static void print(const VMInstruction& inst) {
        printf("cursor=%d key=r%d", cursor_id(inst), key_reg(inst));
        if (jump_if_not_found(inst) >= 0) printf(" notfound->%d", jump_if_not_found(inst));
    }
};
...
// Data Operations
struct Column {
    static VMInstruction create(int32_t cursor_id, int32_t column_index, int32_t dest_reg) {
    ...
    static void print(const VMInstruction& inst) {
        printf("cursor=%d col=%d -> r%d", cursor_id(inst), column_index(inst), dest_reg(inst));
    }
};

struct MakeRecord {
    static VMInstruction create(int32_t first_reg, int32_t reg_count, int32_t dest_reg) {
...
struct Insert {
    static VMInstruction create(int32_t cursor_id, int32_t key_reg, int32_t record_reg) {
    ...
    static void print(const VMInstruction& inst) {
        printf("cursor=%d key=r%d record=r%d", cursor_id(inst), key_reg(inst), record_reg(inst));
    }
};
...
struct Jump {
    static VMInstruction create(int32_t jump_lt, int32_t jump_eq, int32_t jump_gt) {
...
struct Eq {
    static VMInstruction create(int32_t reg_a, int32_t reg_b, int32_t jump_target = -1) {
        return {OP_Eq, reg_a, jump_target, reg_b, nullptr, 0};
    }
    static VMInstruction create_label(int32_t reg_a, int32_t reg_b, const char* label) {
    ...
    static void print(const VMInstruction& inst) {
        ...
        if (jump_target(inst) >= 0) printf(" true->%d", jump_target(inst));
    }
};
...
struct ResultRow {
    ...
    static int32_t reg_count(const VMInstruction& inst) { return inst.p2; }
    static void print(const VMInstruction& inst) {
        printf("r%d..r%d (%d cols)", first_reg(inst), first_reg(inst) + reg_count(inst) - 1, reg_count(inst));
    }
};
...
struct CreateTable {
    ...
    static TableSchema* schema(const VMInstruction& inst) { return (TableSchema*)inst.p4; }
    static void print(const VMInstruction& inst) {
...
struct AggReset {
    ...
    static const char* function_name(const VMInstruction& inst) { return (const char*)inst.p4; }
    static void print(const VMInstruction& inst) {
...
struct AggStep {
    ...
    static void print(const VMInstruction& inst) {
        if (value_reg(inst) >= 0) printf("value=r%d", value_reg(inst));
        else printf("COUNT(*)");
    }
};
...
// Control flow
inline VMInstruction make_trace(const char* message) { return Opcodes::Trace::create(message); }
inline VMInstruction make_goto(int32_t target) { return Opcodes::Goto::create(target); }
inline VMInstruction make_halt(int32_t exit_code = 0) { return Opcodes::Halt::create(exit_code); }
...
inline VMInstruction make_open_write(int32_t cursor_id, const char* table_name, int32_t index_col = 0) {
    return Opcodes::OpenWrite::create(cursor_id, table_name, index_col);
}
inline VMInstruction make_close(int32_t cursor_id) { return Opcodes::Close::create(cursor_id); }
inline VMInstruction make_rewind(int32_t cursor_id, int32_t jump_if_empty = -1) {
...
// Seek operations
inline VMInstruction make_seek_ge(int32_t cursor_id, int32_t key_reg, int32_t jump_if_not_found = -1) {
    return Opcodes::SeekGE::create(cursor_id, key_reg, jump_if_not_found);
}
inline VMInstruction make_seek_gt(int32_t cursor_id, int32_t key_reg, int32_t jump_if_not_found = -1) {
    return Opcodes::SeekGT::create(cursor_id, key_reg, jump_if_not_found);
}
inline VMInstruction make_seek_le(int32_t cursor_id, int32_t key_reg, int32_t jump_if_not_found = -1) {
    return Opcodes::SeekLE::create(cursor_id, key_reg, jump_if_not_found);
}
inline VMInstruction make_seek_lt(int32_t cursor_id, int32_t key_reg, int32_t jump_if_not_found = -1) {
    return Opcodes::SeekLT::create(cursor_id, key_reg, jump_if_not_found);
}
inline VMInstruction make_seek_eq(int32_t cursor_id, int32_t key_reg, int32_t jump_if_not_found = -1) {
    return Opcodes::SeekEQ::create(cursor_id, key_reg, jump_if_not_found);
}

// Data operations
inline VMInstruction make_column(int32_t cursor_id, int32_t column_index, int32_t dest_reg) {
...
inline VMInstruction make_string(int32_t dest_reg, int32_t size, const void* str) {
...
inline VMInstruction make_jump(int32_t jump_lt, int32_t jump_eq, int32_t jump_gt) {
    return Opcodes::Jump::create(jump_lt, jump_eq, jump_gt);
}
inline VMInstruction make_eq(int32_t reg_a, int32_t reg_b, int32_t jump_target = -1) {
    return Opcodes::Eq::create(reg_a, reg_b, jump_target);
}
inline VMInstruction make_ne(int32_t reg_a, int32_t reg_b, int32_t jump_target = -1) {
    return Opcodes::Ne::create(reg_a, reg_b, jump_target);
}
inline VMInstruction make_lt(int32_t reg_a, int32_t reg_b, int32_t jump_target = -1) {
    return Opcodes::Lt::create(reg_a, reg_b, jump_target);
}
inline VMInstruction make_le(int32_t reg_a, int32_t reg_b, int32_t jump_target = -1) {
    return Opcodes::Le::create(reg_a, reg_b, jump_target);
}
inline VMInstruction make_gt(int32_t reg_a, int32_t reg_b, int32_t jump_target = -1) {
    return Opcodes::Gt::create(reg_a, reg_b, jump_target);
}
inline VMInstruction make_ge(int32_t reg_a, int32_t reg_b, int32_t jump_target = -1) {
...
inline VMInstruction make_create_index(int32_t column_index, const char* table_name) {
    return Opcodes::CreateIndex::create(column_index, table_name);
}
inline VMInstruction make_drop_index(int32_t column_index, const char* table_name) {
...
inline VMInstruction make_seek_ge_label(int32_t cursor_id, int32_t key_reg, const char* label) {
    return Opcodes::SeekGE::create_label(cursor_id, key_reg, label);
}
inline VMInstruction make_seek_gt_label(int32_t cursor_id, int32_t key_reg, const char* label) {
    return Opcodes::SeekGT::create_label(cursor_id, key_reg, label);
}
inline VMInstruction make_seek_le_label(int32_t cursor_id, int32_t key_reg, const char* label) {
    return Opcodes::SeekLE::create_label(cursor_id, key_reg, label);
}
inline VMInstruction make_seek_lt_label(int32_t cursor_id, int32_t key_reg, const char* label) {
    return Opcodes::SeekLT::create_label(cursor_id, key_reg, label);
}
inline VMInstruction make_seek_eq_label(int32_t cursor_id, int32_t key_reg, const char* label) {
    return Opcodes::SeekEQ::create_label(cursor_id, key_reg, label);
}
inline VMInstruction make_eq_label(int32_t reg_a, int32_t reg_b, const char* label) {
    return Opcodes::Eq::create_label(reg_a, reg_b, label);
}
inline VMInstruction make_ne_label(int32_t reg_a, int32_t reg_b, const char* label) {
    return Opcodes::Ne::create_label(reg_a, reg_b, label);
}
inline VMInstruction make_lt_label(int32_t reg_a, int32_t reg_b, const char* label) {
    return Opcodes::Lt::create_label(reg_a, reg_b, label);
}
inline VMInstruction make_le_label(int32_t reg_a, int32_t reg_b, const char* label) {
    return Opcodes::Le::create_label(reg_a, reg_b, label);
}
inline VMInstruction make_gt_label(int32_t reg_a, int32_t reg_b, const char* label) {
    return Opcodes::Gt::create_label(reg_a, reg_b, label);
}
inline VMInstruction make_ge_label(int32_t reg_a, int32_t reg_b, const char* label) {
...
inline const char* opcode_to_string(OpCode op) {
    switch(op) {
        ...
        case OP_SeekGE: return "SeekGE";
        case OP_SeekGT: return "SeekGT";
        case OP_SeekLE: return "SeekLE";
        case OP_SeekLT: return "SeekLT";
        case OP_SeekEQ: return "SeekEQ";
        ...
        case OP_ResultRow: return "ResultRow";
        ...
        case OP_AggReset: return "AggReset";
        case OP_AggStep: return "AggStep";
        case OP_AggFinal: return "AggFinal";
...
inline void debug_print_instruction(const VMInstruction& inst, size_t index) {
    ...
    switch(inst.opcode) {
        case OP_Trace: Opcodes::Trace::print(inst); break;
        case OP_Goto: Opcodes::Goto::print(inst); break;
        case OP_Halt: Opcodes::Halt::print(inst); break;
        case OP_OpenRead: Opcodes::OpenRead::print(inst); break;
        case OP_OpenWrite: Opcodes::OpenWrite::print(inst); break;
        case OP_Close: Opcodes::Close::print(inst); break;
        case OP_Rewind: Opcodes::Rewind::print(inst); break;
        case OP_Next: Opcodes::Next::print(inst); break;
        case OP_Prev: Opcodes::Prev::print(inst); break;
        case OP_First: Opcodes::First::print(inst); break;
        case OP_Last: Opcodes::Last::print(inst); break;
        case OP_SeekGE: Opcodes::SeekGE::print(inst); break;
        case OP_SeekGT: Opcodes::SeekGT::print(inst); break;
        case OP_SeekLE: Opcodes::SeekLE::print(inst); break;
        case OP_SeekLT: Opcodes::SeekLT::print(inst); break;
        case OP_SeekEQ: Opcodes::SeekEQ::print(inst); break;
        case OP_Column: Opcodes::Column::print(inst); break;
        case OP_MakeRecord: Opcodes::MakeRecord::print(inst); break;
        ...
        case OP_Integer: Opcodes::Integer::print(inst); break;
        case OP_String: Opcodes::String::print(inst); break;
        case OP_Copy: Opcodes::Copy::print(inst); break;
        case OP_Move: Opcodes::Move::print(inst); break;
        case OP_Compare: Opcodes::Compare::print(inst); break;
        case OP_Jump: Opcodes::Jump::print(inst); break;
        case OP_Eq: Opcodes::Eq::print(inst); break;
        case OP_Ne: Opcodes::Ne::print(inst); break;
        case OP_Lt: Opcodes::Lt::print(inst); break;
        case OP_Le: Opcodes::Le::print(inst); break;
        case OP_Gt: Opcodes::Gt::print(inst); break;
        case OP_Ge: Opcodes::Ge::print(inst); break;
        case OP_ResultRow: Opcodes::ResultRow::print(inst); break;
        case OP_CreateTable: Opcodes::CreateTable::print(inst); break;
        case OP_DropTable: Opcodes::DropTable::print(inst); break;
        case OP_CreateIndex: Opcodes::CreateIndex::print(inst); break;
        case OP_DropIndex: Opcodes::DropIndex::print(inst); break;
        case OP_Begin: Opcodes::Begin::print(inst); break;
        case OP_Commit: Opcodes::Commit::print(inst); break;
        case OP_Rollback: Opcodes::Rollback::print(inst); break;
        case OP_AggReset: Opcodes::AggReset::print(inst); break;
        case OP_AggStep: Opcodes::AggStep::print(inst); break;
        case OP_AggFinal: Opcodes::AggFinal::print(inst); break;
        case Op_Sort: Opcodes::Sort::print(inst); break;
        case Op_Flush: Opcodes::Flush::print(inst); break;
        default:
            printf("p1=%d p2=%d p3=%d p4=%p p5=%d",
                   inst.p1, inst.p2, inst.p3, inst.p4, inst.p5);
    }
    ...
    for (size_t i = 0; i < program.size(); i++) {
        ...
        for (size_t j = 0; j < program.size(); j++) {
            ...
            if ((check.opcode == OP_Goto && check.p2 == (int)i) ||
                (check.opcode >= OP_Eq && check.opcode <= OP_Ge && check.p2 == (int)i) ||
                ...
                ((check.opcode == OP_Rewind || check.opcode == OP_First ||
                  check.opcode == OP_Last) && check.p2 == (int)i) ||
