...
bool vmfunc_like(TypedValue *result, TypedValue *args, uint32_t arg_count) {
...
bool vmfunc_create_index_structure(TypedValue *result, TypedValue *args, uint32_t arg_count) {
...
void demo_composite_index(const char* args) {
    vm_set_result_callback(formatted_result_callback);
    int user_id = 11;
    int min_order_id = 5;
...
bool vmfunc_write_blob(TypedValue *result, TypedValue *args, uint32_t arg_count) {
    if (arg_count != 2) return false;
...
bool vmfunc_read_blob(TypedValue *result, TypedValue *args, uint32_t arg_count) {
    if (arg_count != 1) return false;
...
void demo_blob_storage(const char* args) {
    vm_set_result_callback(formatted_result_callback);
